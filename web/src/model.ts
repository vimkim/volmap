...
export function reduce(state: UiState, action: Action): UiState {
  if (action.kind === "observation-color-mode" || action.kind === "observation-viewport" || action.kind === "observation-due" || action.kind === "toggle-observation" || action.kind === "refresh-observation" || action.kind === "observation-loaded" || action.kind === "observation-ticked") return observationAction(state, action);
