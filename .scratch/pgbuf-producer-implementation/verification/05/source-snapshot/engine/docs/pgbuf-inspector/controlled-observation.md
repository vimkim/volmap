...
## Preconditions and current checks
...
The controller bounds native acknowledgements to eight seconds. The fixture
...
Eviction and complete-versus-partial omission checks are still pending the ticket
05 eviction-method decision. The existing cases do not satisfy that acceptance
