...
- [Prototype the web sector and slotted-page explorer](issues/08-prototype-web-explorer.md) — Use a bounded full-volume mosaic, then replacement drill-down into a large 64-page sector and a detailed page/slot workspace with breadcrumbs and Back navigation, while keeping raw bytes and payloads outside every browser projection.
