...
- Deep inspection may expose structurally proven metadata and bounded raw hexadecimal bytes only when explicitly enabled. It must not decode or expose user values by default.
