...
- [Prototype the web sector and slotted-page explorer](issues/08-prototype-web-explorer.md) — Use Atlas's persistent snapshot/volume/sector hierarchy and 64-page map, borrowing compact responsive details and typed keyboard navigation while keeping all raw bytes and payloads outside every browser projection.
