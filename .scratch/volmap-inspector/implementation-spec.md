...
- Locked and vendored dependencies, embedded notices/SBOM, two byte-identical offline release builds, static-link proof, and execution on the supported Linux distribution matrix.
