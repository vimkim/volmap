...
mod tests {
    ...
    use super::{HTML_PREFIX, HTML_SUFFIX};

    #[test]
    fn frozen_renderer_script_matches_its_content_security_policy_hash() {
        let script = HTML_SUFFIX
            .strip_prefix("</script><script>")
            .unwrap()
            .strip_suffix("</script></body></html>\n")
            .unwrap();
        ...
        assert_eq!(
            &digest[..],
            &[
                0x54, 0xb9, 0x31, 0xb7, 0x01, 0x51, 0x53, 0x5d, 0x3a, 0x6d, 0xf3, 0x03, 0x32, 0xc8,
                0xe3, 0xa3, 0xd1, 0xd2, 0xb4, 0x17, 0x17, 0x51, 0x83, 0x6e, 0x59, 0xbd, 0xfc, 0x25,
                0xae, 0x74, 0x43, 0xae,
            ]
        );
        assert!(HTML_PREFIX.contains("sha256-VLkxtwFRU106bfMDMsjjo9HStBcXUYNuWb38Ja50Q64="));
    }
}
